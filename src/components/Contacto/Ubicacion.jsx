...
const Ubicacion = () => {
    useEffect(() => {
        ...
        const handleMouseOver = (event) => (event.target.style.transform = "scale(1.1)");
        const handleMouseOut = (event) => (event.target.style.transform = "scale(1)");

        const handleBorderOver = (event) => (event.target.style.borderBottom = "2px solid #FF5B00");
        const handleBorderOut = (event) => (event.target.style.borderBottom = "none");
    ...
    return (
        <div className="contenedor-ubi">
            ...
            <div className="header-Contacto">
                <h1>Ubicación</h1>
                <p>
                    Nos encontramos en el corazón de Lima Centro, un lugar vibrante y lleno de vida. Ven a visitarnos en 
                    <b>  TASTY</b> y disfruta de una experiencia culinaria única en un ambiente acogedor y moderno.
                    Estamos ubicados en una zona de fácil acceso, rodeados de los principales puntos de interés de la ciudad.
